...
function ResetPassword() {
    ...
    const onSubmit = async (values) => {
        ...
        let toastify,msg;
        try {
            await axios.put(`${process.env.REACT_APP_BE_SERVER_URL}/api/users/resetPassword/${resetToken.resetToken}`,{password})
            .then(res => {
        ...
        <>
          ...
          <div className="container-fluid content-center img">
                    ...
                    <div className="col-auto mb-3" style={{width:'21.5rem'}}>
                            <h5 className="text-center logo-text display-4">Reset Password</h5>
